This is a project that includes various programs that I wrote for my own personal work but may be useful to others
run Network commands in the console and
Searching for a word in all files in a folder and subfolders and
...
جستجوی کلمه درتمام فایلهای یک فولدر و زیر فولدر و
کار با اکتیو دایرکتوری و
ایجاد رمز و
